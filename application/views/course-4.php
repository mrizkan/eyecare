    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-lg-12">
                    ...
                    <h1 style="margin-top: 4%;">Adults Course</h1>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-7 col-md-push-5 left-block">
                ...
                <p>For job seekers, Professionals, Undergraduates</p>
            ...
            <div class="col-md-5 col-md-pull-7">
                <div class="enquire-wrapper">
                    <figure class="hidden-xs hidden-sm"><img src="images/course-img333.jpg" class="img-responsive" alt=""></figure>
