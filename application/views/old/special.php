                                ...
                                <div class="product-item-container">
                                    ...
                                    <div class="right-block">
                                        ...
                                        <div class="button-group">
                                            <a href="<?= base_url().'Special-Offer-Details/'.url_title($product->OfferProductTitle).'/'.$product->OfferId?>" class="addToCart" type="button" data-toggle="tooltip" title="View More" >
