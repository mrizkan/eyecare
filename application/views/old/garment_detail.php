...
<div id="wrapper" class="wrapper-full ">
    ...
    <div class="main-container container">
        <ul class="breadcrumb">
            ...
            <li> <a href="<?= base_url('Garments/') ?><?= ($details->CategoryId == '1') ? 'Promotional-Item/1' : 'Sport-Item/2';   ?>"> <?= ($details->CategoryId == '1') ? 'Promotional Item' : 'Sport Item';   ?> </a> </li>
<!--            --><?//= $main_cate ?>
<!--            --><?//= $main_cate_sub ?>
                        ...
                        <div class="product-layout">
                            <div class="product-item-container">
                                ...
                                <div class="right-block">
                                    <div class="caption">
                                        <h4>
                                            <a href="<?= base_url().'Garment/'.url_title($related_product->ProductTitle).'/'.$related_product->GarmentId?>">
                                    ...
                                    <div class="button-group">
                                        <a class="addToCart" type="button" data-toggle="tooltip" title="View More" href="<?= base_url().'Garment/'.url_title($related_product->ProductTitle).'/'.$related_product->GarmentId?>" >
