    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-lg-12">
                    ...
                    <h1 style="margin-top: 4%;">Week End Course</h1>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-7 col-md-push-5 left-block">
                ...
                <p>For the students who appeared for GCE (O/L) and GCE (A/L) from 0830 hrs to 1700 hrs 2 week end days for 3 months</p>
            ...
            <div class="col-md-5 col-md-pull-7">
                <div class="enquire-wrapper">
                    <figure class="hidden-xs hidden-sm"><img src="images/course-img222.jpg" class="img-responsive" alt=""></figure>
...
<section class="how-apply padding-lg" style="margin-top: -120px">
    <div class="container">
        ...
        <div class="button-wrapper"> <a href="Contact-Us" class="btn">apply now <span class="icon-more-icon"></span></a> </div>
    </div>
</section>
<!-- End How to Apply -->
