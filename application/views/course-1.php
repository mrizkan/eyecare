    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-lg-12">
                    ...
                    <h1 style="margin-top: 4%;">Residential Course</h1>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-7 col-md-push-5 left-block">
                ...
                <p>for the students who appeared for GCE (O/L) and GCE (A/L) from 0530 hrs to 2030 hrs 7 days per week for 60 days.. </p>
