                ...
                <div class="col-xs-12">
                    <div class="page-title-box">
                        ...
                        <ol class="breadcrumb p-0">
                            ...
                            <li><a href="<?= base_url('admin/Document') ?>"> Document </a></li>
                            <li class="active"> Causes  <?= empty($obj->EventId) ? "Create" : "Edit" ?> </li>
                        </ol>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-8">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="EventTitle" name="form[DocumentTitle]"
                                                               value="<?= $obj->DocumentTitle ?>"
                                                               class="form-control">
                                                        <?= form_error('form[DocumentTitle]') ?>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group" >
                                                ...
                                                <input type="file" id="EventTitle" name="File"
                                                        value="<?= $obj->File ?>"
                                                        class="form-control">
